...
public class PageObjectDesafio {
    ...
    public void escreverUserName(String name){ //escrevendo campo name
        driver.findElement(By.name("username")).sendKeys(name);
    }
    public void escreverPassword(String password){//escrevendo campo password
        driver.findElement(By.name("password")).sendKeys(password);
    }
    public void escreverComments(String writing){//escrevendo campo comments
        driver.findElement(By.name("comments")).sendKeys(writing);//limpando o campo comments
    }
    public void limpandoComments(){//limpando campo comments
        driver.findElement(By.name("comments")).clear();
    }
    public void interagindoCheckBox3(){//interagindo com checkBox 3
        driver.findElement(By.xpath("//*[@id=\"HTMLFormElements\"]/table/tbody/tr[5]/td/input[3]")).click();
    }
    public void interagindoCheckBox1(){// interagindo com checkBox 1
        driver.findElement(By.xpath("//*[@id=\"HTMLFormElements\"]/table/tbody/tr[5]/td/input[1]")).click();
    }
    public void interagindoRadio1(){// interagindo com radio 1
        driver.findElement(By.xpath("//*[@id=\"HTMLFormElements\"]/table/tbody/tr[6]/td/input[1]")).click();
    }
    public void interagindoSelectValues4(){// interagindo com select values 4
        driver.findElement(By.xpath("//*[@id=\"HTMLFormElements\"]/table/tbody/tr[7]/td/select/option[4]")).click();
    }
    public void interagindoSelectValues2(){// interagindo com Select Values 2
        driver.findElement(By.xpath("//*[@id=\"HTMLFormElements\"]/table/tbody/tr[7]/td/select/option[2]")).click();
    }
    public void interagindoDropdown3(){// interagindo com dropdown 3
